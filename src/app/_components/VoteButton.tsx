...
export function VoteButton({
  ...
  isCurrentVote: initialVoteState,
  repoName,
}: VoteButtonProps) {
  ...
  const handleVote = async () => {
    ...
    const toastId = toast.loading(
      initialVoteState ? "Removing vote..." : "Submitting vote...",
    );
  ...
  return (
    ...
    >
      ...
      <span
        className={`relative flex items-center gap-2 ${isVoting ? "mx-auto" : ""}`}
      >
        {isVoting ? (
          <>
            <Spinner />
